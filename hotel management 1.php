...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">ashutoshmail2002@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 7024571991</li>	
					<li class="s-bar">
						<div class="search">
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<span>Manager</span>
							<p>Ashutosh Singh, Purvasha Agrawal, and Vinit Chandra are Computer Science students. He has created this website for his college project.</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 7024571991</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">ashutoshmail2002@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Shivanand nagar sector-1 ,Raipur ,Chhattisagarh,India</p>
